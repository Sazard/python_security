...
docker run -v "$PWD/:/opt/python-securite" --name python-securite --ip 172.18.1.10 --network test_network python-securite:dev /bin/bash /opt/python-securite/tests/run_tests.sh ;